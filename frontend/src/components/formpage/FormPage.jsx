...
import { saveForm, addPlanning, addCrop } from "../../redux/FormSlicer";
...
function FormPage() {
  ...
  const triggerSend = async () => {
    ...
    let response = planning ? await postPlanning(formData) : await postCrop(formData);
    planning ? dispatch(addPlanning(formData)) : dispatch(addCrop(formData));
